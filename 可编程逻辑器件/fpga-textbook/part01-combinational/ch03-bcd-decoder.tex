...
architecture rtl of dynamic_scan is
...
end latched_bcd_decoder;

architecture rtl of latched_bcd_decoder is
  signal latched_bcd : std_logic_vector(3 downto 0);
...
entity bcd_7seg_dual is
  port (
    bcd      : in  std_logic_vector(3 downto 0);
    seg_cath : out std_logic_vector(6 downto 0);  -- 共阴极(1亮)
    seg_anod : out std_logic_vector(6 downto 0)   -- 共阳极(0亮)
  );
end bcd_7seg_dual;

architecture behavioral of bcd_7seg_dual is
begin
  process(bcd)
  begin
    case bcd is
      -- 共阴极(1亮)           -- 共阳极(0亮)
      when "0000" => seg_cath <= "1111110"; seg_anod <= "0000001";  -- 0
      when "0001" => seg_cath <= "0110000"; seg_anod <= "1001111";  -- 1
      when "0010" => seg_cath <= "1101101"; seg_anod <= "0010010";  -- 2
      when "0011" => seg_cath <= "1111001"; seg_anod <= "0000110";  -- 3
      when "0100" => seg_cath <= "0110011"; seg_anod <= "1001100";  -- 4
      when "0101" => seg_cath <= "1011011"; seg_anod <= "0100100";  -- 5
      when "0110" => seg_cath <= "1011111"; seg_anod <= "0100000";  -- 6
      when "0111" => seg_cath <= "1110000"; seg_anod <= "0001111";  -- 7
      when "1000" => seg_cath <= "1111111"; seg_anod <= "0000000";  -- 8
      when "1001" => seg_cath <= "1111011"; seg_anod <= "0000100";  -- 9
      when others => seg_cath <= "0000000"; seg_anod <= "1111111";
    end case;
  end process;
end behavioral;
\end{lstlisting}
