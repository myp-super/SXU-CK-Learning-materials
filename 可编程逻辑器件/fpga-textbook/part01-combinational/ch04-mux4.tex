...
begin
  -- 片0：S1S0选D0-D3
  mux_low: mux4to1 port map(
    D => D(3 downto 0), S => S(1 downto 0), Y => F_low);
  -- 片1：S1S0选D4-D7
  mux_high: mux4to1 port map(
    D => D(7 downto 4), S => S(1 downto 0), Y => F_high);
  -- 顶层2选1
...
end mux4to1_tristate;

architecture rtl of mux4to1_tristate is
begin
