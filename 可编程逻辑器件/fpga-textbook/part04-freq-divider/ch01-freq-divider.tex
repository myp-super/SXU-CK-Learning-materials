...
architecture behavioral of div_power2 is
...
architecture behavioral of even_divider is
...
entity duty_divider is
  generic (M : integer := 10; DUTY : integer := 3);
  port (
    clk     : in  std_logic;
    rst_n   : in  std_logic;
    clk_out : out std_logic
...
architecture behavioral of duty_divider is
  signal cnt : std_logic_vector(3 downto 0);
begin
  process(clk, rst_n)
  begin
