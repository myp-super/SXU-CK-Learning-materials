...
architecture behavioral of modn_en_counter is
...
end modn_load_counter;

architecture behavioral of modn_load_counter is
  signal cnt_reg : std_logic_vector(3 downto 0);
begin
  process(clk, rst_n)
  begin
...
architecture behavioral of updown_counter is
  signal cnt_reg : std_logic_vector(WIDTH-1 downto 0);
begin
  process(clk, rst_n)
  begin
    if rst_n = '0' then
...
begin
  ...
  begin
    if rst_n = '0' then
      ...
      if cnt_reg = 0 then
        cnt_reg <= to_unsigned(PRE, cnt_reg'length);
      else
        cnt_reg <= cnt_reg - 1;
      end if;
    end if;
